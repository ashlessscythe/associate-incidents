...
app.get("/zapi/notifications/:associateId", async (req, res) => {
  try {
    const { associateId } = req.params;
...
app.post("/zapi/notifications", async (req, res) => {
  try {
    const { associateId, date, type, level, totalPoints, description } = req.body;
...
app.put("/zapi/notifications/:id", async (req, res) => {
  try {
    const { id } = req.params;
...
app.delete("/zapi/notifications/:id", async (req, res) => {
  try {
    const { id } = req.params;
